...
#model solution used a direction variable and an if-elif-elif-elif chain to set x and y, and if maximum value was reached it just set the next direction.
