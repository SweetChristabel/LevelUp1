...
#Model solution, instead of just using lambdas everywhere and doubling like I did, 
#defined separate credit summer and grade summer functions and reused those instead.
